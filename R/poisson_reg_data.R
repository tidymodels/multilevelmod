...
make_stan_poisson_reg <- function() {
  ...
  parsnip::set_model_engine("poisson_reg", "regression", "stan-glmer")
  parsnip::set_dependency("poisson_reg", "stan-glmer", "rstanarm")
  parsnip::set_dependency("poisson_reg", "stan-glmer", "multilevelmod")
